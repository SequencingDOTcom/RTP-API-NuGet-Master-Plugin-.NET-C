...
* .NET/C# (NuGet plugin) <-- Sample contained as a subfolder within this repo
...
Resources
======================================
* [+RTP API Developer Documentation](https://sequencing.com/developer-documentation/api-guides/real-time-personalization+RTP-api)
